...
#Imagine you work for an airline and need to compare the flight routes of your airline with a competitor. You have two sets of flight 
...
print(f"Shared routes: {mutual_routes}")
print(f"Only our routes: {our_unique_routes}")
print(f"Unique Roues: {unique_routes}")
